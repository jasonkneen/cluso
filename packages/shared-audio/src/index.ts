 ...
 *
 * Audio encoding/decoding utilities for ai-cluso applications.
 * Works in both Electron and browser (Chrome extension) contexts.
 */

/**
 * Audio blob structure for Gemini API
 */
...
/**
 * Creates an audio blob structure for the Gemini SDK
 */
export function createAudioBlob(inputData: Float32Array): AudioBlob {
...
/**
 * Gets an AudioContext, handling webkit prefix for older browsers
 */
...
/**
 * Play a simple tone for audio feedback
 */
